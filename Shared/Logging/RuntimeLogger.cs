...
namespace IngameScript {
    ...
    public class RuntimeLogger {
        ...
        readonly Queue<string> _actionLog = new Queue<string>();
        readonly List<string> _warningOrder = new List<string>();
        readonly Dictionary<string, int> _warnings = new Dictionary<string, int>();
        readonly HashSet<string> _oneShotWarnedKeys = new HashSet<string>();
        readonly List<string> _oneShotWarnedMessages = new List<string>();
        readonly HashSet<string> _actionOnceKeys = new HashSet<string>();
        readonly StringBuilder _echoBuffer = new StringBuilder();
        ...
        public void LogAction(string msg) {
            ...
            while (_actionLog.Count > MaxActionLogEntries) _actionLog.Dequeue();
        }
