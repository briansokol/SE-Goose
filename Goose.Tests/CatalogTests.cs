...
namespace Goose.Tests
{
    ...
    public class CatalogTests
    {
        ...
        public class BuildKey_Tests
        {
            ...
            {
                string key = Program.Catalog_BuildKey(MyItemType.MakeOre("Iron"));
            ...
            {
                string key = Program.Catalog_BuildKey(MyItemType.MakeIngot("Gold"));
            ...
            {
                string key = Program.Catalog_BuildKey(MyItemType.MakeComponent("SteelPlate"));
            ...
            {
                string key = Program.Catalog_BuildKey(MyItemType.MakeAmmo("NATO_25x184mm"));
