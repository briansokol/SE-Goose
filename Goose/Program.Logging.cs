...
namespace IngameScript
{
    public partial class Program : MyGridProgram
    {
        ...
        private void LogAction(string msg)
        {
            ...
            while (_actionLog.Count > _config.MaxActionLogEntries)
            {
                _actionLog.Dequeue();
            }
        }
        ...
        private void LogWarningOnce(string key, string msg)
        {
        ...
        private void LogActionOnce(string key, string msg)
        {
        ...
        /// </summary>
        private void ResetOneShotWarnings()
        {
